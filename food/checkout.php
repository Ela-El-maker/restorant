...
<?php
   ...
   if(isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO orders (name, email, town,country,zipcode,address,phone_number,total_price, user_id) VALUES (:name, :email, :town,:country,:zipcode,:address,:phone_number,:total_price, :user_id)";
